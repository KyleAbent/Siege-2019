...
Shine.VoteMenu:AddPage ("SpendClasses", function( self )
   ...
   -- self:AddSideButton( "WelderExo", function() Shared.ConsoleCommand ("sh_buyclass Welder")  end)
    --self:AddSideButton( "FlamerExo", function() Shared.ConsoleCommand ("sh_buyclass Flamer")  end)
        elseif player:GetTeamNumber() == 2 then
