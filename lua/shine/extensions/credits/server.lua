/*Kyle 'Avoca' Abent Karmas Season 3
KyleAbent@gmail.com 
*/
local Shine = Shine
local Plugin = Plugin
   ...
   local delete = GetSetupConcluded()
      if delete then
            ...
            local entity = table.random(entities)
             if entity:GetMapName() == Sentry.kMapName or entity:GetMapName() == Observatory.kMapName or entity:GetMapName() == ARCKarma.kMapName  then return true end
